...
function chart(){
		...
		$("#chartDonut1").html(gradientChart.generateLegend()); 
		var gradientChartCanvas = $("#chartDonut1").get(0).getContext("2d");
		var gradientChart = new Chart(gradientChartCanvas, {
		  type: 'doughnut',
		  data: ChartData,
		  options: gradientChartOptions,
		...
		$("#chartDonut2").html(gradientChart.generateLegend()); 
		$("#chartDonut2").html(gradientChart.generateLegend()); 
		var gradientChartCanvas = $("#chartDonut2").get(0).getContext("2d");
		var gradientChart = new Chart(gradientChartCanvas, {
		  type: 'doughnut',
		  data: ChartData,
		  options: gradientChartOptions,
		...
		$("#chartDonut4").html(gradientChart.generateLegend()); 
		$("#chartDonut4").html(gradientChart.generateLegend()); 
		$("#chartDonut4").html(gradientChart.generateLegend()); 
		var gradientChartCanvas = $("#chartDonut4").get(0).getContext("2d");
		var gradientChart = new Chart(gradientChartCanvas, {
		  type: 'doughnut',
		  data: ChartData,
		  options: gradientChartOptions,
